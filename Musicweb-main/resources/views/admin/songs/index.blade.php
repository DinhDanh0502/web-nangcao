...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <form action="{{ route('admin.songs.index') }}" method="GET" id="searchForm">
                <div class="row">
                    <!-- Ô nhập từ khóa -->
                    <div class="col-md-5">
        ...
        <table class="table table-bordered mt-2">
            <thead class="thead-light">
                <tr>
                    ...
                    <th>Tên bài hát</th>
                    <th>Nghệ sĩ chính</th>
                    <th>Nghệ sĩ cộng tác</th>
                    <th>Thể loại chính</th>
                    <th>Thể loại bổ sung</th>
                    <th>Thời lượng</th>
                    <th>Hành động</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($song->cover_url)
                            <img src="{{ asset('storage/' . $song->cover_url) }}" alt="{{ $song->title }}" 
                    ...
                    <td>
                        <a href="{{ route('admin.songs.show', $song->id) }}" class="btn btn-info btn-sm">
                            <i class="fas fa-eye"></i> Xem
                        </a>
                        <a href="{{ route('admin.songs.edit', $song->id) }}" class="btn btn-warning btn-sm">Sửa</a>
