...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <form action="{{ route('admin.playlists.index') }}" method="GET" id="searchForm">
                <div class="row">
                    <!-- Ô nhập từ khóa -->
                    <div class="col-md-5">
        ...
        <table class="table table-bordered mt-2">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.playlists.show', $playlist->id) }}" class="btn btn-info btn-sm">
                            <i class="fas fa-eye"></i> Xem
                        </a>
                        <a href="{{ route('admin.playlists.edit', $playlist->id) }}" class="btn btn-warning btn-sm">Sửa</a>
                        <form action="{{ route('admin.playlists.destroy', $playlist->id) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
